...
spellings produce identical canonical strings, so equivalence-class
testing in R is just string comparison on the canonical form.
...
Parse failures are signaled as a typed `mm_formula_error` condition
