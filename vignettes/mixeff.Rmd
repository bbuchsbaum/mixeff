...
- `glmm()`'s default estimator (`pirls_profiled`) returns point
  ...
  and p-values; refit with `method = "joint_laplace"` for
  glmer-comparable certified inference, or use
  `confint(fit, method = "bootstrap")` for parametric-bootstrap
  intervals on any supported family, including negative binomial
