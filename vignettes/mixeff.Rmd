...
stopifnot("boundary_parameter" %in% diag_codes)
...
each one a closed-enum *reason* for its status, and names the verb
...
- fit GLMMs end-to-end; `glmm()` is a typed boundary today
