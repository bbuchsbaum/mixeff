...
the parity ledger. The labelled joint route is available as
`method = "joint_laplace"`; for the intact model the budgeted audit route
(`mm_control(max_feval = 40)`) substantially reduces the lme4 gap, but still
returns an explicit budget-limited, non-certified optimizer diagnostic.
